...
/**
 * Specifies mapping rules to convert OpenTelemetry's {@link Resource} to Google specific {@link
 * GcpResource}.
 */
public interface ResourceMapper {
   ...
   * @return the converted {@link GcpResource}.
   */
  GcpResource mapResource(Resource resource);
}

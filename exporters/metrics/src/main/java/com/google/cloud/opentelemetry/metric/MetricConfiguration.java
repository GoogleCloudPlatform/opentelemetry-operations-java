...
public abstract class MetricConfiguration {
   ...
   *
   * <p>This returns the {@link MetricConfiguration#DEFAULT_RESOURCE_MAPPER} if not set through
   * exporter configuration.
   *
   * @return the {@link ResourceMapper} object responsible for mapping OpenTelemetry resource to
   *     Monitored Resource.
   */
  ...
  public abstract static class Builder {
     ...
     * com.google.api.MonitoredResource}s. This overrides the default resource mapping logic.
     *

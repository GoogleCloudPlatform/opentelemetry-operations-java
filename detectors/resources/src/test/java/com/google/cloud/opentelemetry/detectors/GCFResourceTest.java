...
public class GCFResourceTest {
  ...
  public void findsWithServiceLoader() {
    ...
    assertTrue(
        "Could not load CloudFunction Resource detector using serviceloader, found: " + services,
        services.stream().anyMatch(provider -> provider.type().equals(GCFResource.class)));
  }

  @Test
  public void testCloudFunctionNotGCP() {
    GCFResource testResource = new GCFResource();
  ...
  @Test
  public void testCloudFunctionResourceNonGCPEndpoint() {
    ...
    GCFResource testResource = new GCFResource(metadataConfig, new EnvVarMock(envVars));
    assertThat(testResource.getAttributes()).isEmpty();
  }

  @Test
  public void testCloudFunctionResourceWithCloudFunctionAttributesSucceeds() {

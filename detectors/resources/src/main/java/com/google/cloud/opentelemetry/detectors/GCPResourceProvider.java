...
public class GCPResourceProvider implements ResourceProvider {
  ...
  private void addGCEAttributes(
      AttributesBuilder attrBuilder, Map<String, Optional<String>> attributesMap) {
    attrBuilder.put(
